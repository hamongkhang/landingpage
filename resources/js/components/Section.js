  ...
  return (
    ...
    <section id="about" className="about">
      <div className="container-fluid">
        <div className="row">
          <div id="youtube" className="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch" >
          <iframe id="videoclip"  src="https://www.youtube.com/embed/v6BAKdfRq6s" frameborder="0"></iframe>
          ...
          <div className="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" >
            ...
            <p>Trong khi đó, với sự hỗ trợ và khuyến khích mạnh mẽ của chính phủ, Đà Nẵng được xác định trở thành trung tâm CNTT trong tương lai. Vì vậy, đây là nơi lý tưởng để sinh viên chúng tôi tìm kiếm cơ hội việc làm ổn định sau khi tốt nghiệp.</p>
            <SectionChild />
