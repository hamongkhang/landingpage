               ...
               { this.state.background_items.map((background_item, i) => {
                ...
                <li   data-aos-delay={100}>
                    <div className="goals">
                      ...
                      <a data-toggle="collapse" className="collapsed" href={"#boi"+background_item.id}><h5><b>{background_item.background_item_title}</b></h5>
                        <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                    </div>
                    <div id={"boi"+background_item.id} className="collapse" data-parent=".boi-list">
                      <p>
